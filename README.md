...
- Reports with monthly trends, aging analysis, average collection period
- Zip backup with photos and staged restore with rollback
- Soft delete for safe data removal
- Chinese / English language toggle
- Expression input for quick amount entry
...
| Dashboard | Reports |
|-----------|---------|
| ![dashboard](screenshots/dashboard.jpg) | ![reports](screenshots/reports.jpg) |
